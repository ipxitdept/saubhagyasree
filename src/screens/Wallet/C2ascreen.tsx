...
import { useCreateC2aMutation,  useGetWalletQuery } from '../../services/type';
...
const C2aScreen = () => {
  ...
  const [createC2a] = useCreateC2aMutation();
  ...
  return (
    <HelmetScreen>
      <SafeAreaView style={[style.container]}>
        ...
        >
          <HeaderScreen title="C2A" showBackButton={true} />
          ...
          <View style={styles.walletCard}>
            ...
            <Text style={styles.balanceLabel}>Capital Balance</Text>
            <Text style={styles.balanceAmount}>
              $ {data?.data?.capital_wallet}
            </Text>
