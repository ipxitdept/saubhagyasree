...
export { useGetDashboardQuery,useGetWalletQuery,useGetIncomeHistoryQuery } from './dashboard/dashboard';
export { useGetUserDetailsQuery,useUpdateUserProfileMutation,useUpdateUserBankMutation,useUpdatePaymentMutation } from './user/user';
...
export {useGetLevelTeamQuery,useGetLevelMemberQuery,useGetGenealogyQuery} from './team/team'